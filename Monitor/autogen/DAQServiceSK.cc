...
void
_objref_DAQService::_enableShortcut(omniServant* _svt, const _CORBA_Boolean* _inv)
{
  if (_svt)
    _shortcut = (_impl_DAQService*)_svt->_ptrToInterface(::DAQService::_PD_repoId);
  else
    _shortcut = 0;
  _invalid  = _inv;
...
//
// Code for DAQService::setCommand
...
//
// Code for DAQService::getCommand
...
//
// Code for DAQService::setCompParams
...
void _objref_DAQService::setCompParams(const ::NVList& comp_params)
{
  ...
  if (_s) {
    if (!*_invalid) {
      _s->setCompParams(comp_params); return;
    }
    else {
      _enableShortcut(0,0);
      // drop through to normal invoke
...
//
// Code for DAQService::getCompParams
...
//
// Code for DAQService::setFatalStatus
...
void _objref_DAQService::setFatalStatus(const ::FatalErrorStatus& fatalStaus)
{
  ...
  if (_s) {
    if (!*_invalid) {
      _s->setFatalStatus(fatalStaus); return;
    }
    else {
      _enableShortcut(0,0);
      // drop through to normal invoke
...
//
// Code for DAQService::getFatalStatus
